...
SECRET_KEY = 'wfd%j1k+=(!hb8-3jme_4uk%n#!m6t$x7&hncvg)p&$v%)3k1l'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True # 修改

ALLOWED_HOSTS = ['*'] # 允許使用者 *所有
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3', # 設定資料庫
    }
}
